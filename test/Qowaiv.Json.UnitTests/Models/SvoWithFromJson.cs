...
internal readonly struct SvoWithFromJson : System.IEquatable<SvoWithFromJson>
{
    ...
    /// <summary>Convention based factory method.</summary>
    public static SvoWithFromJson FromJson(double json) => new SvoWithFromJson(json);

    /// <summary>Convention based factory method.</summary>
    public static SvoWithFromJson FromJson(long json) => new SvoWithFromJson(json);

    /// <summary>Convention based factory method.</summary>
    public static SvoWithFromJson FromJson(bool json) => new SvoWithFromJson(json);
